        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="">
                        <a href="admin_landing.php"><i class="fa fa-user"></i> <span class="nav-label">Manage User</span> </a>
                    </li>
                    <li class="">
                        <a href="admin_role.php"><i class="fa fa-gear"></i> <span class="nav-label">Manage Role</span> </a>
                    </li>
                    <li class="">
                        <a href="admin_bank.php"><i class="fa fa-bank"></i> <span class="nav-label">Manage Bank</span></a>
                    </li>
                    <li class="">
                        <a href="admin_logs.php"><i class="fa fa-book"></i> <span class="nav-label">Manage Logs</span></a>
                    </li>
                    <li class="active">
                        <a href="admin_katalog.php"><i class="fa fa-book"></i> <span class="nav-label">Manage Katalog</span></a>
                    </li>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="btn-primary btn btn-xs"><a class="text-white" href="edit_katalog.php?id=<?php echo $data['id_katalog'] ?>">Edit</a></button>
                                                        <button class="btn-danger btn btn-xs ml-1"><a class="text-white" href="../action/action_delete_katalog.php?id=<?php echo $data['id_katalog'] ?>">Delete</a></button>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Katalog</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <form action="../action/action_tambah_katalog.php" method="post">
                                                <div class="modal-body">
                                                    <input type="text" name="katalog" class="form-control">
                                                </div>
