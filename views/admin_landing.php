                            ...
                            <div class="ibox-content">
                                ...
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                    ...
                                    <tbody>
                                        <?php
                                        include 'koneksi.php';
                                        $query = "select * from user inner join role on user.id_role = role.id_role";
                                        $output = $koneksi->query($query);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="btn-primary btn btn-xs"><a class="text-white" href="edit_user.php?id=<?php echo $data['id_user'] ?>">Edit</a></button>
                                                        <button class="btn-danger btn btn-xs ml-1"><a class="text-white" href="../action/action_delete_user.php?id=<?php echo $data['id_user'] ?>">Delete</a></button>
