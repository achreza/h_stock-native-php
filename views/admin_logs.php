                            ...
                            <div class="ibox-content">
                                ...
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                    ...
                                    <tbody>
                                        <?php
                                        include 'koneksi.php';
                                        $query = "select * from logs join user on logs.id_user = logs.id_user";
                                        $output = $koneksi->query($query);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="btn-primary btn btn-xs"><a class="text-white" href="edit_logs.php?id=<?php echo $data['id_logs'] ?>">Edit</a></button>
                                                        <button class="btn-danger btn btn-xs ml-1"><a class="text-white" href="../action/action_delete_logs.php?id=<?php echo $data['id_logs'] ?>">Delete</a></button>
