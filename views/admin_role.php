                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="btn-primary btn btn-xs"><a class="text-white" href="edit_role.php?id=<?php echo $data['id_role'] ?>">Edit</a></button>
                                                        <button class="btn-danger btn btn-xs ml-1"><a class="text-white" href="../action/action_delete_role.php?id=<?php echo $data['id_role'] ?>">Delete</a></button>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="../action/action_tambah_role.php" method="post">
