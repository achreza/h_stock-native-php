                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="btn-primary btn btn-xs"><a class="text-white" href="edit_foto.php?id=<?php echo $data['id_foto'] ?>">Edit</a></button>
                                                        <button class="btn-danger btn btn-xs ml-1"><a class="text-white" href="../action/action_delete_foto.php?id=<?php echo $data['id_foto'] ?>">Delete</a></button>
