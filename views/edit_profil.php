                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                <form method="POST" action="../action/action_edit_profil.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group  row"><label class="col-sm-2 col-form-label">Country</label>
                                        ...
                                        <div class="col-sm-10"><input type="text" class="form-control" name="country"></div>
                                    </div>


                                    <div class="hr-line-dashed"></div>

                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Foto Profil</label>
