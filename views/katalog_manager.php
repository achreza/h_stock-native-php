                                ...
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-hide="all">Nama Katalog</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="btn-primary btn btn-xs"><a class="text-white" href="list_katalog.php?id=<?php echo $data['id_katalog'] ?>">Lihat Katalog</a></button>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="../action/action_tambah_list_katalog.php" method="post">
                                                <div class="modal-body">
                                                    Masukkan Foto :
                                                    <select name="foto" class="form-control mb-3">
                                                        <?php
                                                        include 'koneksi.php';
                                                        $query = "select * from foto where id_user = $id";
                                                        $output = $koneksi->query($query);


                                                        while ($data = $output->fetch_array()) {
                                                        ?>
                                                            <option value="<?php echo $data['id_foto'] ?>"><?php echo $data['nama_foto'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                    Pilih katalog :
                                                    <select name="katalog" class="form-control">
                                                        ...
                                                        while ($data = $output->fetch_array()) {
                                                        ?>
                                                            <option value="<?php echo $data['id_katalog'] ?>"><?php echo $data['nama_katalog'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
