                                ...
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-hide="phone">Nama Foto</th>
                                            <th data-hide="all">Tanggal Upload</th>
                                            <th data-hide="all">Harga Foto</th>
                                    ...
                                    <tbody>
                                        <?php
                                        include 'koneksi.php';
                                        $query = "select * from katalog join list_katalog on katalog.id_katalog = list_katalog.id_katalog join foto on list_katalog.id_foto = foto.id_foto where foto.id_user = $id AND katalog.id_katalog =$idkatalog";
                                        $output = $koneksi->query($query);
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <?php echo $data['id_foto'] ?>
                                                </td>
                                                <td>
                                                    <img src="../img/foto/<?php echo $data['nama_foto'] ?>" alt="Foto" width="100px">
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="btn-danger btn btn-xs ml-1"><a class="text-white" href="../action/action_delete_isi_katalog.php?id=<?php echo $data['id_foto'] ?>">Delete From Katalog</a></button>
