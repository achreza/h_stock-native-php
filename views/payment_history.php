                                ...
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-hide="all">Total Downloads</th>
                                            <th data-hide="all">Total Pendapatan</th>
                                    ...
                                    <tbody>
                                        <?php
                                        include 'koneksi.php';
                                        $query = "select * from foto join conpayment on foto.id_foto = conpayment.id_foto where foto.id_user = '$id'";
                                        $output = $koneksi->query($query);
