                            ...
                            <div class="ibox-content">
                                ...
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                    ...
                                    <tbody>
                                        <?php
                                        include 'koneksi.php';
                                        $query = "select DISTINCT * from foto inner join pembayaran on foto.id_foto = pembayaran.id_foto where pembayaran.id_buyer = '2'";
                                        $output = $koneksi->query($query);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="btn-primary btn btn-xs"><a class="text-white" href="../img/foto/<?php echo $data['nama_foto'] ?>">Show Pict</a></button>
